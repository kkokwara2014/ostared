...
@section('title')
    {{ $caption->name }} Postings ({{ $caption->postings->count() }})
@endsection
                                                            ...
                                                            <div class="card card-rounded">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            {{-- <a href="{{ route('redeploystaff', $caption) }}"
                                                                            ...
                                                                            <a href="{{ route('redeploystaff', $caption) }}"
                                                                                ...
                                                                                Redeploy</a>
                                                                            @if ($postings->count())
                                                                                <a href="{{ route('printdeployedstaff', $caption) }}"
                                                                                    class="btn btn-lg btn-otline-dark btnprnt"><i
                                                                                    ...
                                                                                    @foreach ($postings as $posting)
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <h6>
                                                                                                    <a
                                                                                                        href="{{ route('redeploysinglestaff', [$posting->staff->phone, $caption]) }}">Redeploy
                                                                                                        Staff</a>
                                                                                                    |
                                                                                                    <a
