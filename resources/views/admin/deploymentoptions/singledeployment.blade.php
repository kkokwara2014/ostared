                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-sm-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <h2>
                                                    @yield('title') <small style="color: red">(Select a Unit and a staff
                                                        to make deployment)</small>
                                                </h2>
                                        ...
                                        <form method="POST" action="{{ route('deployastaff', $caption) }}"
                                            class="forms-sample">
                                            @csrf
                                                    ...
                                                    <tbody>
                                                        @foreach ($staffs as $staff)
                                                            <tr>
                                                                <td>
                                                                    <div class="form-check form-check-flat mt-0">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" name="staff_id"
                                                                                value="{{ $staff->id }}"
                                                                                class="form-check-input"
                                                                ...
                                                                <td>
                                                                    <h6>
                                                                        <a href="{{ route('staff.show', $staff->phone) }}">View
                                                                            Postings</a>
                                                                    </h6>
                                                                </td>
                                                                <td>
                                                                    {{-- <form
                                                                        action="{{ route('continuesinglestaffdeployment', [$staff->id, $caption]) }}"
                                                                        method="post">
                                                                        @csrf --}}


                                                                    {{-- <button type="submit"
                                                                            class="btn btn-primary me-2 text-white">Continue
                                                                            >></button>
                                                                    </form> --}}
                                                                </td>
