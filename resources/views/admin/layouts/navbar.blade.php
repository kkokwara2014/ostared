    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            ...
            <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard') }}">
                <img src="{{ asset('bootstrap_assets/assets/images/logo-mini.svg') }}" alt="logo" />
            </a>
        </div>
    </div>
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
            @if (Route::is('dashboard'))
                <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                    ...
                    <h3 class="welcome-sub-text">Stats of Staff Redeployment </h3>
                </li>
            @endif
        </ul>
        ...
        <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                ...
                <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                        <img src="{{ asset('bootstrap_assets/assets/images/faces/face10.jpg') }}"
                ...
                <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                        <img src="{{ asset('bootstrap_assets/assets/images/faces/face12.jpg') }}"
                            alt="image" class="img-sm profile-pic">
                    </div>
                    <div class="preview-item-content flex-grow py-2">
                ...
                <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                        <img src="{{ asset('bootstrap_assets/assets/images/faces/face1.jpg') }}"
                            alt="image" class="img-sm profile-pic">
                    </div>
                    <div class="preview-item-content flex-grow py-2">
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <img class="img-xs rounded-circle" src="{{ url('user_images', auth()->user()->userimage) }}"
                        alt="Profile image">
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                        <img class="img-md rounded-circle" src="{{ url('user_images', auth()->user()->userimage) }}"
                            alt="Profile image">
                        <p class="mb-1 mt-3 fw-semibold">{{ Auth::user()->name }}</p>
                        <p class="fw-light text-muted mb-0">{{ Auth::user()->email }}</p>
                    </div>
                    <a href="{{ route('profile', Auth::user()->phone) }}" class="dropdown-item"><i
