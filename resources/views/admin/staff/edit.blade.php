                            ...
                            <div class="col-md-9 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('staff.update', $staff->phone) }}"
                                            class="forms-sample">
                                            @csrf
                                            @method('put')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="othername"
                                                    placeholder="Other Name" value="{{ $staff->othername }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    maxlength="11" pattern="[0-9]+" value="{{ $staff->phone }}">
                                                @if ($errors->has('phone'))
                                                    <span class="invalid-feedback" role="alert">
                                                ...
                                                <select class="form-select" required name="rank_id">
                                                    ...
                                                    @foreach ($ranks as $rank)
                                                        <option value="{{ $rank->id }}" style="color: black;"
                                                            {{ $rank->id == $staff->rank_id ? 'selected' : '' }}>
                                                            {{ $rank->name }}</option>
                                                    @endforeach
                                                ...
                                                <select class="form-select" required name="gender_id">
                                                    ...
                                                    @foreach ($genders as $gender)
                                                        <option value="{{ $gender->id }}" style="color: black;"
                                                            {{ $gender->id == $staff->gender_id ? 'selected' : '' }}>
                                                            {{ $gender->name }}</option>
                                                    @endforeach
